...
<script>
import ToggleDarkMode from "@/components/docc/ToggleDarkMode";
import Logo from '@/components/docc/Logo';
import { SunIcon, MoonIcon, GlobeIcon, GithubIcon, TwitterIcon } from "vue-feather-icons";

const Search = () => import(/* webpackChunkName: "search" */ "@/components/docc/Search").catch(error => console.warn(error));
