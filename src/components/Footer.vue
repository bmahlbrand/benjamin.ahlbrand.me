  ...
  <div>
    <div class="bg-white">
      <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="sm:mt-4 md:mt-6 lg:mt-8 grid grid-cols-3 gap-0.5 ">
          <div class="col-span-1 flex justify-center sm:py-0 px-8 bg-gray-50">
            <img
    ...
    <div class="bg-gray-50" id="faq">
      <div class="max-w-screen-xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
          ...
          <FAQ v-for="edge in $static.faqs.edges" :key="edge.node.position" :question="edge.node.question" :answer="edge.node.content" :faq="edge.node"/>
      ...
      <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        >
          ...
          <p class="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
            &copy; 2020 <a href="https://autotoon.com">Autotoon, Inc.</a> All rights reserved.
          </p>
        </div>
      </div>
    </div>
...
<static-query>
query {
  faqs: allFaq(sortBy: "position", order: ASC) {
    edges {
      node {
        id,
        question,
  ...
  mounted() {
      ...
      if (iframes.length > 0) {
        iframes.forEach(element => {
          ...
          if (element.contentWindow.document.getElementsByClassName("gallery").length > 0 ) { 
            // console.log("found element")
            let widget = element.contentWindow.document.getElementsByClassName("gallery")[0];
            let e = widget.children[1] // the clapping hands text
            console.log(e);
